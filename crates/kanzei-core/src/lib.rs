...
pub use store::{
    ...
    EpisodeRecord, FunnelCounts, RecallEvent, RecallLinkStats, RecallMetrics, ResearchRunEvent,
    ResearchRunRecord, Session, SessionArtifactReport, SessionDeletionPlan, SessionDeletionResult,
    SessionFact, SessionFactEnvelope, SessionFactError, SessionInvariant, SessionProjection,
    SessionStore, SessionTurnTerminal, ShadowComparison, ShadowVerdictStats, StorageBackupReport,
