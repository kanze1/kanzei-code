...
The submitted prompt is in `oc-pixel-v3.prompt.md`.

The UI uses warm charcoal, paper white and restrained champagne accents, informed
...
sends them outward; completion briefly settles to champagne.
