...
export const I18N_EN = {
  ...
  "思考:服务商默认": "Reasoning: provider default",
  "思考:无": "Reasoning: none",
  "思考:低": "Reasoning: low",
  "思考:中": "Reasoning: medium",
  "思考:高": "Reasoning: high",
  "思考:超高": "Reasoning: xhigh",
  "思考:最大": "Reasoning: max",
  ...
  "作用域选择器只覆盖模型配置;Provider 与 API Key 始终写全局配置": "This scope selector only applies to model settings; providers and API keys always use the global config.",
  "默认(交给模型决定)": "Default (let the model decide)",
  "无思考(部分模型支持)": "None (supported by some models)",
  "超高": "Extra high",
  "最大": "Maximum",
  "顶栏可按进程临时覆盖。默认不发送档位，让模型或服务商决定；无思考仅对支持它的模型生效，超高和最大也按各模型支持范围处理。": "The top bar can override this per process. The default omits an effort value and lets the model or provider decide. None is only supported by some models; xhigh and max are mapped to each model's supported levels.",
