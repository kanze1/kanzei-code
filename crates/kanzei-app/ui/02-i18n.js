const I18N_EN = {
  ...
  "对话顶部显示使用手册": "Show manual at top of conversation",
  "关闭后对话区顶部不再展示 docs/目录.md 使用手册区块(有该文件时)。": "When off, the project manual block (docs/manual file) no longer appears at the top of the conversation.",
  "停止中…": "Stopping…",
