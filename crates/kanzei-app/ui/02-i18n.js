const I18N_EN = {
  ...
  "文本层已检查 · 语义层未检查": "Text overlap checked · semantic overlap unchecked",
  "当前未发现跨线文件交集": "No cross-line file overlap found",
  "个重叠文件": "overlapping files",
  "条运行中": "running",
  "条线路": "lines",
  "个改动文件": "changed files",
  "当前项目还没有可显示的线路": "This project has no lines to display yet",
  "未声明条目": "No item declared",
  "阶段": "Phase",
  "当前工具": "Current tool",
  "分支": "Branch",
  "工作树": "Worktree",
  ...
  "令牌": "Tokens",
  "当前线路": "Current line",
  "切换到此线路": "Switch to this line",
  "并行线路读取失败": "Failed to load parallel lines",
  "合并前检查失败": "Pre-merge check failed",
  "仍要继续进入 Git 合并吗": "Continue to the Git merge anyway?",
  "检测到跨线文件交集": "Cross-line file overlap detected",
  "项": "items",
  "继续进入 Git 合并吗": "Continue to the Git merge?",
  "并行线路已创建": "Parallel line created",
  "创建并行线路失败": "Failed to create parallel line",
  "写主根追踪器": "Write main-root trackers",
  "允许当前分支线修改主项目唯一的需求、缺陷、目标、决策等 tracker 文档。默认关闭；读取始终可用。": "Allow this branch line to modify the main project's canonical tracker documents, including work items, defects, goals, and decisions. Off by default; reads are always available.",
  ...
  "复杂度": "Complexity", "未评估": "Not assessed", "未设": "Unset", "本页": "this page", "实际生效": "effective", "手填": "typed manually", "未命名文件": "untitled file", "工作树清单读取失败": "Failed to read worktree list", "设置缺陷复杂度": "Set defect complexity", "设置需求复杂度": "Set requirement complexity", "复杂度已保存": "Complexity saved",
...
const I18N_DYNAMIC_EN = {
  ...
  "当前分支线已允许写主根追踪器": "This branch thread may now write the main-root trackers",
  "当前分支线已恢复为只读主根追踪器": "This branch thread is read-only for main-root trackers again",
  "更新追踪器写入权限失败": "Failed to update tracker write permission",
