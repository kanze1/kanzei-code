...
- 后端:crates/kanzei-app/src/projects.rs 中 export_pick_dir / export_project_data(经 main.rs pub use 注册进 invoke_handler)。
- 前端:crates/kanzei-app/ui/16-settings.js 设置页"工作资料导出"区(原 ui/main.js 已拆分为模块)。
