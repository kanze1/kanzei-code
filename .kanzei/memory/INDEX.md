...
- M-061 [sop] 自举复盘 SOP:审提交流水、验收证据、测试面匹配、证据链、残留 — 每次自举运行结束后做质量复盘时必读
- M-062 [fact] 环境约束:本机 WebView2 151 DevTools 端口从不绑定,e2e CDP 路线不可用 — 想走 e2e-smoke / connectOverCDP / WebView2 DevTools 端口路线前必读:已 9 轮实验证实,不要重推
