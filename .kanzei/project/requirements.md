...
## R-182 撤销项目级单 writer:文档单份靠主根重定向、代码靠分支合并,写仲裁回归 git 与既有文件锁 [todo]
- 优先级: P0
- 复杂度: 中
- 标签: 核心
- 归属: kanzei
...
## R-183 kz 无人值守执行通道:EOF 不默认 Deny、permission 规则 worktree 继承主根、可审计预授权集 [todo]
- 优先级: P0
- 复杂度: 中
- 标签: 核心
- 归属: kanzei
...
## R-184 协作可见性双面:线的上下文里要有其他线,界面要能并列看每条线在干嘛与是否冲突 [todo]
- 优先级: P0
- 复杂度: 中
- 标签: 核心 前端
- 归属: kanzei
...
- refs: R-182 R-177 R-179 R-181 R-183 D-263 docs/design/parallel_read_serial_write_orchestration.md
