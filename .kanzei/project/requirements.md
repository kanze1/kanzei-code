...
- 进展: 复核验收原文与现有变更，继续补齐完成判定执行约束；托管规范文档必须通过专用 tracker/项目机制更新，不能直接 edit。
...
## R-095 活动面板:工具调用可筛选折叠、后台任务可操作 [todo]
...
## R-124 SOP 从成功轨迹自动提炼与模板库管理 [todo]
- 复杂度: 中
- 优先级: P1
- 归属: kanzei
...
## R-126 agent 的前端自查能力与专用编辑工具 [todo]
- 复杂度: 大
- 优先级: P1
- 归属: kanzei
