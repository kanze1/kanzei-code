...
- 状态: todo
- 依赖: D-428
- 阻塞: 单 WIP 槽停车(不是外部依赖)。D-428 关闭后本条随即变成可执行，与 R-216、R-281、D-349 同时挤在单槽上触发 wip_violation；按 defect-first 让 D-349 持槽。解除人:用户(或本线在 D-349 收口后恢复)——这条是显式停车,复核阻塞时不要当作失效自阻塞清掉。
...
- 状态: todo
- 依赖: D-428
- 阻塞: 单 WIP 槽停车(不是外部依赖)。D-428 关闭后本条随即变成可执行，与 R-221、R-281、D-349 同时挤在单槽上触发 wip_violation；按 defect-first 让 D-349 持槽。解除人:用户(或本线在 D-349 收口后恢复)——这条是显式停车,复核阻塞时不要当作失效自阻塞清掉。
...
- 阻塞: 单 WIP 槽停车(不是外部依赖)。批1 已提交(ed305ae8),批2/批3 待做;与 R-221、R-216、D-349 同时挤在单槽上触发 wip_violation，按 defect-first 让 D-349 持槽。解除人:用户(或本线在 D-349 收口后恢复)——这条是显式停车,复核阻塞时不要当作失效自阻塞清掉。
