...
## R-036 双状态 agent:自主推进(backlog驱动/连跑)与结伴开发(Claude式对话协作),设计 docs/design/interaction-modes.md [todo]

## R-037 对话为主布局:主区只留对话与思考,工具活动收束到右侧活动面板,一行痕迹可展开(设计见 interaction-modes.md 附录) [todo]
