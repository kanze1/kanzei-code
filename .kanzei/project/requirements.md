...
- 优先级: P2
- 批次: 1/1
- 进展: B1 已落地：docs/design/metrics_baseline.md 更新为 2026-08-18 `kz metrics --top 30` 实测榜单，记录全仓 210 个 .rs、9 个生产行超过 1200 的巨石；证据 T-1786922726397。B2 已落地：actions.rs 校验/展示/ID 辅助函数迁移到 tracker/actions/action_helpers.rs；证据 T-1786922726398，kanzei-tools 345 passed。B3 已落地：test_record.rs 覆盖查询与六条前端 smoke 判定迁移到 test_record/coverage.rs；证据 T-1786922726399。B4a 已落地：background.rs persistent 注册表迁移到 background/persistent.rs；提交 6a21d4f9、证据 T-1786922726400。B4b 已落地：metrics-regression-gate.ps1 接入 verify.ps1 crate_sync；提交 6b1a48b4、证据 T-1786922726401。B4c 已落地：run_cli 输入解析抽到 resolve_cli_input；提交 bca87cd8、证据 T-1786922726405。B4d 已落地：drive.rs question 解析抽到 runner/drive/question.rs；提交 d13599a9、证据 T-1786922726406。B4e-B4g 已落地：drive.rs task/普通工具 ToolOutput 转换统一迁移到 runner/drive/task_results.rs；提交 4425d6ac、c2fb3a62、e34601b9，证据 T-1786922726407-T-1786922726409。B4h 已落地：ReadonlyProfile 迁移到 profiles/readonly.rs；证据 T-1786922726410。B5 已落地：ResearchProfile 工具注册、权限配置与 index_of 迁移到 profiles/research.rs:12-246；真实调用方为 profiles.rs:603-665 的 ResearchProfile::contribute；提交 214ae962，证据 T-1786922726411、T-1786922726412。B6 已落地并提交 a7def4cb：将 drive.rs:1191-1298 的串行 ruleset/session/ASK 权限判定迁移到 runner/drive/permissions.rs:1-128，由 drive.rs:11-16、1195-1210 的 `execute_tool_calls` 真实调用；D-534 已 fixed，证据 T-1786922726415。B7 已落地并提交 525d65d2：将 drive.rs 原串行普通工具执行段迁移至 runner/drive/serial_tools.rs:28-227，由 drive.rs:1129-1149 的 execute_tool_calls 通过 SerialToolRequest 真实调用；首次导入缺失已登记 D-535 并 fixed，证据 T-1786922726417。B8 已落地：将 06-agent-panel.js 的子代理运行/完成/关闭、transcript、usage、单条停止和面板控制能力迁入 06-activity.js:919-1288；真实事件调用方仍为 07-events.js:192,215,266。index.html:1134 只加载 06-activity.js，06-agent-panel.js:1 仅保留历史路径提示；03-shell.js:638 与 scripts/ui-esm-graph.json:161,395-397,1056 同步新的提供方，docs/目录.md:582 同步文件职责。验收对账：①已落地多组 Rust/工具拆解，但 drive.rs 并行主体以及其他 Rust/前端 Top 目标仍未全部拆解，保持活动；证据 525d65d2、前述迁移文件与既有 T-1786922726397。②已完成 06-agent-panel 与 06-activity 合流：能力实现 06-activity.js:919-1288，真实消费者 07-events.js:192,215,266，唯一加载入口 index.html:1134；T-1786922726419 证明非 vendor UI JS 语法、六条 smoke 和 ui-esm-graph JSON 解析通过。③回涨闸门已在 scripts/verify.ps1:56-61 生效，证据 T-1786922726401。④metrics 对照已落 docs/design/metrics_baseline.md:1-61，实测命令 `kz metrics --top 30`，证据 T-1786922726397。下一步：提交 B8 变更后继续处理 R-300 验收①剩余 Top 目标；R-300 保持 doing。
- observed_head: 525d65d27011898907bdbcb4edf43d0b7c5d4055
- observed_worktree_hash: fnv1a64:46098976aa8138e3
- recorded_at: 1787070442024
- R-300: 2/4
