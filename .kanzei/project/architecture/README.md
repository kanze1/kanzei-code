...
- [identity: live_design; last_verified_commit: 1ebbb218] [`research_experiment_runner.md`](../../../docs/design/research_experiment_runner.md)：Research 实验运行与路线图的字段与 Markdown 格式冻结(两层模型 探索→实验结果、@@kanzei 回调协议、本机+SSH 执行、环境策略分档、路线图投影,附可照抄骨架;A-014~A-019,R-343~R-348 承接)。
