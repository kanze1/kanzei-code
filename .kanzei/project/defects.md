...
## D-692 ui-markdown-smoke 仍以 Function 执行 ESM 源码导致迁移后冒烟崩溃 [fixing] (medium)
...
- 优先级: P1
- 状态: 
- 进展: 已修复并验证：scripts/ui-markdown-smoke.mjs:1-5 直接 import ../crates/kanzei-app/ui/04-markdown.js 的 renderMarkdown，移除 new Function 源码执行路径。D-692 验收=“ui-markdown-smoke 能执行当前 ESM 形式的 04-markdown.js，并继续保留现有 markdown 断言；node scripts/ui-markdown-smoke.mjs 通过”→实现位置 scripts/ui-markdown-smoke.mjs:1-5；行为证据 T-1786922726754（六条前端冒烟全绿）。
- observed_head: 8d35b99178bef97e54ad31a201a28b4ad0055e60
- observed_worktree_hash: fnv1a64:c4a18d31110ba943
- recorded_at: 1787343811525
