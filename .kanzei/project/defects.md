...
## D-605 R-318/W4 DevProfile 插入设计索引时残留孤立 draft.agents.insert 导致编译失败 [open] (high)
...
## D-606 R-318/W4 设计时效脚本 Windows 入口判断静默跳过门禁 [open] (high)
...
## D-607 R-318/W4 harness_m1 文档头与架构索引身份冲突 [open] (medium)
