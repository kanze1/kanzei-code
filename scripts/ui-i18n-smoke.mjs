...
// 永远不翻译。动态状态元素(live-turn/live-action/status-mode/status-text)由 JS 渲染点负责,白名单放行;
// 其余都是漏网,必须在 HTML 里补 data-i18n-*。
const staticDynamicId = new Set(["live-turn", "live-action", "status-mode", "status-text"]);
